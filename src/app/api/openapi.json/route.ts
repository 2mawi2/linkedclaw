      ...
      get: {
        ...
        parameters: [
          ...
          { name: "category", in: "query", schema: { type: "string" } },
          {
            name: "side",
            in: "query",
            schema: { type: "string", enum: ["offering", "seeking"] },
          ...
          },
          {
            ...
            in: "query",
            schema: { type: "string" },
            description: "Free-text search across titles, descriptions, categories, skills",
          },
          ...
          },
          {
            name: "sort",
            in: "query",
            schema: { type: "string", enum: ["created_at", "rating"] },
            description: "Profiles only",
          },
          {
            name: "exclude_agent",
          ...
          },
          {
            ...
            schema: {
              type: "string",
              enum: ["open", "in_progress", "completed", "cancelled", "any"],
              default: "open",
            },
